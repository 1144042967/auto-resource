...
public class ItemManager {
    public static void onCreativeModeTabRegister(CreativeModeTabEvent.Register event) {
        event.registerCreativeModeTab(new ResourceLocation(AutoResource.MODID, "autoresource"), builder -> builder.title(Component.translatable("itemGroup.autoresource"))
                .icon(() -> new ItemStack(Registration.ENERGY_GENERATOR_FE_ITEM.get()))
                .displayItems((parameters, output, value) -> {
    ...
    public static void init() {
        FMLJavaModLoadingContext.get().getModEventBus().addListener(ItemManager::onCreativeModeTabRegister);
    }
}
