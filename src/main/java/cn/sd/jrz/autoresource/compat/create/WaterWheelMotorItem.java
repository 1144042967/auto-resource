 ...
 * <p>26.1.2：Item 构造要求 Properties.setId(ResourceKey)；appendHoverText 签名改为 TooltipDisplay + Consumer。
 */
public class WaterWheelMotorItem extends BlockItem {
    ...
    /**
     * 物品名称使用水主题色（与水生成机一致）。26.1.2：Item 默认名称键为 item.&lt;id&gt;，语言文件用 block.&lt;id&gt;，
     * 显式改用方块翻译键。
     */
    @Override
